//handling everything is yours responsibilty !
//open and close the connection in each request
...
var connectionConfig = {
    userName: 'shani',
    password: 'sbh0308..',
    server: "shani.database.windows.net",
    options: { encrypt: true, database: 'shaniDB' }
};
