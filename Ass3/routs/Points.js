//This class responsible about the points requests 
...
//get specfic point of intersest
...
router.get('/getAllPoints',function(req,res) {
   DButilsAzure.execQuery(`select PointsOfInterest.pointID, PointsOfInterest.pointName, PointsOfInterest.sumOfGrade, PointsOfInterest.numOfGrade , Category.category ,PointsImages.pointLink from PointsOfInterest
    JOIN Category ON PointsOfInterest.catID = Category.catID FULL OUTER JOIN PointsImages ON PointsImages.pointID=PointsOfInterest.pointID`)
         .then(function (result) {
                res.send(result);
            })
           .catch((err)=>{
